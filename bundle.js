...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUp = function signUp(event) {
	  ...
	  var name = $("#sign-up input[name='credentials[email]']").val();
	  ...
	  api.signUp(data).done(ui.signUpSuccess).fail(ui.signInFail);
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#getGame-modal-button').on('click', function () {
	    $('#getGame-modal').modal('show');
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onShowAllGames = function onShowAllGames(event) {
	  event.preventDefault();
	  api.index().done(ui.successShowAllGames).fail(ui.failure);
	};

	var onShowStatistics = function onShowStatistics(event) {
	  event.preventDefault();
	  api.index().done().fail(ui.failure);
	};

	var onShowGame = function onShowGame(event) {
	  event.preventDefault();
	  var data = $('#game-id').val();
	  console.log('Show Game ' + data);
	  api.showGame(data).done(ui.successShowGame).fail(ui.failure);
	};

	var onPlayerJoin = function onPlayerJoin(event) {
	  event.preventDefault();
	  var gameId = $('#game-id-join').val();
	  api.playerJoin(gameId).done(ui.successPlayerJoin).fail(ui.failure);
	};

	var checkNextMove = function checkNextMove(currentMove) {
	...
	var onMoveHere = function onMoveHere(event) {
	  event.preventDefault();
	  var move = checkNextMove(currentMove);
	  console.log('current move is ' + move);
	  var gameId = $('.game-board').attr('value');
	  console.log('the game id is ' + gameId);
	  $("input[name='game[cell][value]']").val(move);
	  var data = getFormFields(event.target);
	  console.log('Inside some shit: ', data);

	  var spot = event.target.id;

	  console.log('spot is ' + spot);
	  api.addMove(data, gameId).done(ui.successUpdateBoard).fail(ui.failure);
	...
	var onCreateNewGame = function onCreateNewGame(event) {
	  ...
	  api.createNewGame().done(ui.successNewGame).fail(ui.failure);

	  currentMove = 1;
	};

	var onStatistics = function onStatistics(event) {
	  event.preventDefault();
	  api.index().done(ui.updateStatistics).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	//data: data
	var playerJoin = function playerJoin(gameId) {
	  return $.ajax({
	...
	var addMove = function addMove(data, gameId) {
	  return $.ajax({
	    url: app.host + '/games/' + gameId,
	    method: 'PATCH',
	    headers: {
	...
	var updateGameStatus = function updateGameStatus(gameId) {
	  return $.ajax({
	    url: app.host + '/games/' + gameId,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var successNewGame = function successNewGame(data) {
	  console.log(data.game.id);
	  var newGameId = data.game.id;
	  $('.wrapper').html();
	  $('.wrapper').html("<section class='game-board' value='" + newGameId + "'>" + "<form class='game-square col-xs-4' id='index0'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='0'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index1'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='1'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index2'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='2'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index3'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='3'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index4'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='4'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index5'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='5'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index6'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='6'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index7'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='7'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form>" + "<form class='game-square col-xs-4' id='index8'>" + "<input class='cell-number' name='game[cell][index]' type='submit' value='8'>" + "<input class='cell-move' name='game[cell][value]' type='text' value=''>" + "<input class='submit-move' type='submit' value='Move Here'>" + "</form></section>");
	};

	var successShowAllGames = function successShowAllGames(data) {
	  console.log('Displaying all games');
	  console.table(data.games);
	  console.log(data.games.length);
	};

	var successShowGame = function successShowGame(data) {
	  console.log('Showing game' + $('#game-id').val());
	  console.log(data.game);
	};

	var successPlayerJoin = function successPlayerJoin(data) {
	  console.log('Player o sucessfully joined');
	  console.log(data.game);
	};

	var successAddMove = function successAddMove(data) {
	  console.log('Move successfully added');
	  console.log(data.game);
	};

	var successUpdateBoard = function successUpdateBoard(data) {
	  console.log('current board ' + data.game.cells);
	  var moveData = data.game.cells;
	...
	var updateStatistics = function updateStatistics(data) {
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  successNewGame: successNewGame,
	  successShowAllGames: successShowAllGames,
	  successShowGame: successShowGame,
	  successPlayerJoin: successPlayerJoin,
	  successAddMove: successAddMove,
	  successUpdateBoard: successUpdateBoard,
	  addImage: addImage,
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var hasEmptyString = function hasEmptyString(element) {
	  return element === "";
	};

	var checkStatus = function checkStatus(array, gameId) {
	  if (array[0] === array[1] && array[0] === array[2] && array[0] !== '') {
	    console.log('Player ' + array[0] + ' wins!');
	    var winner = array[0];
	    api.updateGameStatus(gameId).done(removeButtons).fail(failure);
	    showWinner(winner);
